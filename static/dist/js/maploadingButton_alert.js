document.addEventListener("DOMContentLoaded", function() {
    var submitButton = document.getElementById("map-submit-button");
    submitButton.setAttribute("data-original-text", submitButton.innerHTML);
});

document.getElementById("map-upload-form").addEventListener("submit", function(event) {
    event.preventDefault();
    var fileInput = document.getElementById("map-file-upload");
    ...
    fetch(form.action, {
        ...
        window.location.href = '/mapwasdetected';
    }).catch(error => {
